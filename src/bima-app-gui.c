...
#line 568 "bima-app-gui.c"
/* self casting macros */
#define SELF(x) BIMA_APP_GUI(x)
#define SELF_CONST(x) BIMA_APP_GUI_CONST(x)
#define IS_SELF(x) BIMA_IS_APP_GUI(x)
#define TYPE_SELF BIMA_TYPE_APP_GUI
#define SELF_CLASS(x) BIMA_APP_GUI_CLASS(x)

#define SELF_GET_CLASS(x) BIMA_APP_GUI_GET_CLASS(x)

/* self typedefs */
typedef BimaAppGui Self;
typedef BimaAppGuiClass SelfClass;

/* here are local prototypes */
static void bima_app_gui_class_init (BimaAppGuiClass * c) G_GNUC_UNUSED;
static void bima_app_gui_init (BimaAppGui * self) G_GNUC_UNUSED;

/* pointer to the class of our parent */
static GtkWindowClass *parent_class = NULL;

/* Short form macros */
#define self_fill_step1_combo bima_app_gui_fill_step1_combo
#define self_show_modules bima_app_gui_show_modules
#define self_show_tables bima_app_gui_show_tables
#define self_show_views bima_app_gui_show_views
#define self_show_reports bima_app_gui_show_reports
#define self_show_forms bima_app_gui_show_forms
#define self_show_current_state bima_app_gui_show_current_state
#define self_new bima_app_gui_new
GType
bima_app_gui_get_type (void)
{
	static GType type = 0;

	if ___GOB_UNLIKELY(type == 0) {
		static const GTypeInfo info = {
			sizeof (BimaAppGuiClass),
			(GBaseInitFunc) NULL,
			(GBaseFinalizeFunc) NULL,
			(GClassInitFunc) bima_app_gui_class_init,
			(GClassFinalizeFunc) NULL,
			NULL /* class_data */,
			sizeof (BimaAppGui),
			0 /* n_preallocs */,
			(GInstanceInitFunc) bima_app_gui_init,
			NULL
		};

		type = g_type_register_static (GTK_TYPE_WINDOW, "BimaAppGui", &info, (GTypeFlags)0);
	}
...
#define GET_NEW ((BimaAppGui *)g_object_new(bima_app_gui_get_type(), NULL))

/* a function for creating a new object of our type */
#include <stdarg.h>
static BimaAppGui * GET_NEW_VARG (const char *first, ...) G_GNUC_UNUSED;
static BimaAppGui *
GET_NEW_VARG (const char *first, ...)
{
	...
	va_list ap;
	va_start (ap, first);
	ret = (BimaAppGui *)g_object_new_valist (bima_app_gui_get_type (), first, ap);
	va_end (ap);
	return ret;
}
...
{
#define __GOB_FUNCTION__ "Bima:App:Gui::finalize"
	BimaAppGui *self G_GNUC_UNUSED = BIMA_APP_GUI (obj_self);
...
static void 
bima_app_gui_class_init (BimaAppGuiClass * c G_GNUC_UNUSED)
{
#define __GOB_FUNCTION__ "Bima:App:Gui::class_init"
...
#line 628 "appgui.gob"
static void 
bima_app_gui_init (BimaAppGui * self G_GNUC_UNUSED)
#line 677 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::init"
#line 591 "appgui.gob"
	self->app_data = bima_app_data_new();
#line 682 "bima-app-gui.c"
#line 592 "appgui.gob"
	self->cur_obj = NULL;
#line 685 "bima-app-gui.c"
#line 594 "appgui.gob"
	self->query =  NULL ;
#line 688 "bima-app-gui.c"
 {
#line 629 "appgui.gob"
...
#line 770 "appgui.gob"
void 
bima_app_gui_fill_step1_combo (BimaAppGui * self, gchar * template_dir)
#line 841 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::fill_step1_combo"
#line 770 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 770 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 848 "bima-app-gui.c"
{
#line 772 "appgui.gob"
...
#line 885 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 807 "appgui.gob"
void 
bima_app_gui_show_modules (BimaAppGui * self, GList * next_list, gchar * parent_id, GtkTreeIter parent_iter)
#line 891 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_modules"
#line 807 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 807 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 898 "bima-app-gui.c"
{
#line 808 "appgui.gob"
...
#line 952 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 860 "appgui.gob"
void 
bima_app_gui_show_tables (BimaAppGui * self, gchar * module_id, GtkTreeIter module_iter)
#line 958 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_tables"
#line 860 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 860 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 965 "bima-app-gui.c"
{
#line 862 "appgui.gob"
...
#line 1024 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 919 "appgui.gob"
void 
bima_app_gui_show_views (BimaAppGui * self)
#line 1030 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_views"
#line 919 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 919 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 1037 "bima-app-gui.c"
{
#line 921 "appgui.gob"
...
#line 1070 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 952 "appgui.gob"
void 
bima_app_gui_show_reports (BimaAppGui * self)
#line 1076 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_reports"
#line 952 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 952 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 1083 "bima-app-gui.c"
{
#line 954 "appgui.gob"
...
#line 1118 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 987 "appgui.gob"
void 
bima_app_gui_show_forms (BimaAppGui * self)
#line 1124 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_forms"
#line 987 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 987 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 1131 "bima-app-gui.c"
{
#line 989 "appgui.gob"
...
#line 1168 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 1024 "appgui.gob"
void 
bima_app_gui_show_current_state (BimaAppGui * self)
#line 1174 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::show_current_state"
#line 1024 "appgui.gob"
	g_return_if_fail (self != NULL);
#line 1024 "appgui.gob"
	g_return_if_fail (BIMA_IS_APP_GUI (self));
#line 1181 "bima-app-gui.c"
{
#line 1026 "appgui.gob"
...
#line 1252 "bima-app-gui.c"
#undef __GOB_FUNCTION__

#line 1095 "appgui.gob"
GtkWidget * 
bima_app_gui_new (void)
#line 1258 "bima-app-gui.c"
{
#define __GOB_FUNCTION__ "Bima:App:Gui::new"
{
#line 1097 "appgui.gob"
	
		return (GtkWidget*) GET_NEW;
	}}
#line 1266 "bima-app-gui.c"
#undef __GOB_FUNCTION__
